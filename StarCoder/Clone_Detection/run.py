...
class TextDataset(Dataset):
    def __init__(self, tokenizer, args, file_path='train', block_size=512, pool=None):
        ...
        url_to_code = {}
        with open('/codes/codes/Clone_Detection/starcoder/data.jsonl') as f:
            for line in f:
                line = line.strip()
                js = json.loads(line)
                url_to_code[js['idx']] = " ".join(js['func'])
...
def evaluate(args, model, tokenizer,  pool=None,eval_when_training=False):
