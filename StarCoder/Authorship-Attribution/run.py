...
def convert_examples_to_features(code, label,tokenizer, block_size):
    ...
    def __init__(self, tokenizer, args, file_path=None):
        ...
        with open(file_path) as f:
            for line in f:
                ...
                # 将这俩内容转化成input.
                self.examples.append(convert_examples_to_features(code, int(label), tokenizer, args.block_size))
