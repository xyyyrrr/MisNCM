...
def main():
    ...
    if args.model_name_or_path:
        original_state_dict = torch.load('./saved_models/gcjpy/checkpoint-best-acc/adv-yangzhou.bin')
    ...
    source_codes = []
    with open(args.eval_data_file, 'r', encoding='utf-8') as file:
        for line in file:
            source_codes.append(line.strip())
        is_success = 0
        total_cnt = 0
        id_not_match_idx = []
